...
describe("Test City Reducer", () => {
  ...
  it("Test cityCurrData action", () => {
    ...
    const newCityContext = cityReducer(
      initialState,
      cityActions.setCityCurrData(data)
    );
    const expected = {
  ...
  it("Test CityForeCastData action", () => {
    ...
    const newCityContext = cityReducer(
      initialState,
      cityActions.setCityForeCastData(data)
    );
    const expected = {
      city: { id: 3038789, nm: "Abbeville", lat: 50.099998, lon: 1.83333 },
      cityCurrData: {},
  ...
  it("Test CityCurrLoading action", () => {
    ...
    const newCityContext = cityReducer(
      initialState,
      cityActions.setCityCurrLoading(loading)
    );
    const expected = {
      city: { id: 3038789, nm: "Abbeville", lat: 50.099998, lon: 1.83333 },
      cityCurrData: {},
  ...
  it("Test cityForeLoading action", () => {
    ...
    const newCityContext = cityReducer(
      initialState,
      cityActions.setCityForeLoading(loading)
    );
    const expected = {
      city: { id: 3038789, nm: "Abbeville", lat: 50.099998, lon: 1.83333 },
      cityCurrData: {},
